...
| 03 | [Log de Decisões](docs/03-log-de-decisoes-v0.24.md) | **156 decisões com justificativa.** Consulte antes de perguntar |
...
| 12 | [CLAUDE.md](docs/12-claude-md-v0.18.md) | Fonte do `CLAUDE.md` da raiz |

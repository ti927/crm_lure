...
| 03 | [Log de Decisões](docs/03-log-de-decisoes-v0.18.md) | **143 decisões com justificativa.** Consulte antes de perguntar |
...
| 12 | [CLAUDE.md](docs/12-claude-md-v0.11.md) | Fonte do `CLAUDE.md` da raiz |

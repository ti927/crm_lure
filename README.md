...
Toda a documentação viva está em [docs/](docs/). Comece por [00 — Status e Retomada](docs/00-status-e-retomada-v2.1.md), que diz onde o projeto está e qual é a próxima ação.

| # | Documento | Para quê |
|---|---|---|
| 00 | [Status e Retomada](docs/00-status-e-retomada-v2.1.md) | Onde o projeto está e o que vem a seguir |
...
| 03 | [Log de Decisões](docs/03-log-de-decisoes-v0.14.md) | **118 decisões com justificativa.** Consulte antes de perguntar |
...
| 09 | [Arquitetura Técnica](docs/09-arquitetura-tecnica-v0.5.md) | Schema físico, gatilhos, políticas |
...
| 12 | [CLAUDE.md](docs/12-claude-md-v0.6.md) | Fonte do `CLAUDE.md` da raiz |

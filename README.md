...
Toda a documentação viva está em [docs/](docs/). Comece por [00 — Status e Retomada](docs/00-status-e-retomada-v2.9.md), que diz onde o projeto está e qual é a próxima ação.

| # | Documento | Para quê |
|---|---|---|
| 00 | [Status e Retomada](docs/00-status-e-retomada-v2.9.md) | Onde o projeto está e o que vem a seguir |
...
| 03 | [Log de Decisões](docs/03-log-de-decisoes-v0.20.md) | **146 decisões com justificativa.** Consulte antes de perguntar |
...
| 12 | [CLAUDE.md](docs/12-claude-md-v0.13.md) | Fonte do `CLAUDE.md` da raiz |

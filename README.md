...
| 03 | [Log de Decisões](docs/03-log-de-decisoes-v0.29.md) | **166 decisões com justificativa.** Consulte antes de perguntar |
...
| 08 | [UI e Design System](docs/08-ui-e-design-system-v0.2.md) | Cores, tipografia, densidade |
...
| 12 | [CLAUDE.md](docs/12-claude-md-v0.24.md) | Cópia do `CLAUDE.md` da raiz. ⚠️ **A raiz é a que vale** — esta é espelho, e envelhece sem que nada acuse; em dia em 08/09 |

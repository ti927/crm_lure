...
Toda a documentação viva está em [docs/](docs/). Comece por [00 — Status e Retomada](docs/00-status-e-retomada-v1.5.md), que diz onde o projeto está e qual é a próxima ação.

| # | Documento | Para quê |
|---|---|---|
| 00 | [Status e Retomada](docs/00-status-e-retomada-v1.5.md) | Onde o projeto está e o que vem a seguir |
...
| 12 | [CLAUDE.md](docs/12-claude-md-v0.4.md) | Fonte do `CLAUDE.md` da raiz |
